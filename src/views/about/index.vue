<template>
  <div class="container">
    ...
    <div class="content-container markdown-body animated fadeIn">
      <h3>简介</h3>
      <p>本站点主要维护人程序员小姚，一个主web开发90后普通程序员，然后活在这个不痛不痒的世界里。因为以前比较喜欢玩电脑，而且觉得写代码很牛逼的亚子，所以大学学了计算机，之后便在程序袁的不归路上越走越远......  </p>
      ...
      <h3>宗旨</h3>
      <p>本博客宗旨主要分享作者在生活和工作中读过的好文章，以及作者在生活和工作过程中遇到的一些问题的记录，一些心得以及总结的输出。希望通过文章记录的这种方式沉淀下自己，同时也希望能帮到更多的人，交到更多志同道合的朋友，聊聊<code>哲学♂</code>，谈谈<code>橘子♀</code>。咳咳~~~</p>
      <h3>项目开源</h3>
      <p>项目包括前后端，都是臭弟弟程序员小姚本人写的，前端项目使用Vue全家桶 + Element-UI编写，后端使用SpringBoot + MyBatis-Plus + Security搭建的博客服务Api。项目目前都已在Github上开源，欢迎star哦～</p>
      <ul>
